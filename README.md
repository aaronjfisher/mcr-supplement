...
Code to reproduce results from Section 9.1 & 10 of [Fisher et al., 2019](http://www.jmlr.org/papers/v20/18-760.html), for calculating model reliance and model class reliance.
